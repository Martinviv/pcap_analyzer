...
def graph_camera(conf1, conf2, file):
    packet_cam1, packet_cam2 = main.execute_multiple_config('mapping_camera_mvt/' + conf1, 'mapping_camera_mvt/' + conf2, file)
    ...
    cusum_search(timestamp_rate_cam1, timestamp_rate_cam2)
...
def cusum_search(timestamp_rate_cam1, timestamp_rate_cam2):
    ...
    print(timestamp_rate_cusum_cam1)
